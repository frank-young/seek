...
var config = {
    ...
    card: "pQw7gv4tnvAt_M2avr2JW_Zog8Bw",  // 原来 ：pQw7gvyKKtUmYGizNvXKYIn15vGc  新卡：pQw7gv4tnvAt_M2avr2JW_Zog8Bw  测试：
    code: "435350747055"
}
...
exports.addmenu = function(req, res) {
    ...
    var menus = {
        "button": [{
            "name": "品牌故事",
            "sub_button": [
                { "type": "view", "name": "品牌故事", "url": "http:\/\/55735016.m.weimob.com\/WEISITE\/detail?did=2534329&bid=56673821&pid=55735016", "sub_button": [] }
            ]
        }, { "name": "会员消息", "sub_button": [
            { "type": "view", "name": "最新活动", "url": "http:\/\/55735016.m.weimob.com\/weisite\/list?pid=55735016&bid=56673821&wechatid=fromUsername&ltid=1739279&wxref=mp.weixin.qq.com&_tt=2&channel=menu%5E%23%5E5pyA5paw5rS75Yqo", "sub_button": [] }, 
            { "type": "view", "name": "微信打印机", "url": "http:\/\/prtv3.etbar.com\/uweb\/index.aspx?userid=1311&ucode=AsBSkMLRgD1o", "sub_button": [] }
            ]
        }, 
            { "name": "关于我们", "sub_button": [
            { "type": "view", "name": "门店信息", "url": "http:\/\/55735016.m.weimob.com\/weisite\/list?pid=55735016&bid=56673821&wechatid=fromUsername&ltid=1818666&wxref=mp.weixin.qq.com&_tt=2&channel=menu%5E%23%5E6Zeo5bqX5L+h5oGv", "sub_button": [] }, 
            { "type": "view", "name": "诚邀加盟", "url": "http:\/\/55735016.m.weimob.com\/webreserve\/ReserveBook?rid=71459&pid=55735016&wechatid=fromUsername&_tt=2&channel=menu%5E%23%5E6K+a6YKA5Yqg55uf", "sub_button": [] }, 
            { "type": "view", "name": "推荐选址", "url": "http:\/\/55735016.m.weimob.com\/webreserve\/ReserveBook?rid=71460&pid=55735016&wechatid=fromUsername&_tt=2&channel=menu%5E%23%5E5o6o6I2Q6YCJ5Z2A", "sub_button": [] }, 
...
exports.cardCreate = function(req, res) {
    ...
    var formdata = {
        "card": {
            ...
            "member_card": {
                "base_info": {
                    "id": "pQw7gvyKKtUmYGizNvXKYIn15vGc",
                    ...
                    "sku": {
                        "quantity": 999999984,
                        "total_quantity": 999999996
                    },
                    "create_time": 1476862469,
                    "update_time": 1480573389,
...
exports.cardResponse = function(req, res) {
    ...
    if (msg.msgtype == 'text') {
        ...
        if (msg.content == '西可咖啡') {
            ...
            content = "<a href='http://139.129.239.39/manager/index'>点击查看</a>"
            msgReplay(msg, res, content)
        } else {
            res.end('')
        }
