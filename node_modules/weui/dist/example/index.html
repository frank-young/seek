...
<div class="page">
    ...
    <div class="page__bd page__bd_spacing">
        <a href="javascript:;" class="weui-btn weui-btn_default" id="showDialog1">iOS Dialog样式一</a>
        <a href="javascript:;" class="weui-btn weui-btn_default" id="showDialog2">iOS Dialog样式二</a>
        <a href="javascript:;" class="weui-btn weui-btn_default" id="showDialog3">Android Dialog样式一</a>
        <a href="javascript:;" class="weui-btn weui-btn_default" id="showDialog4">Android Dialog样式二</a>
    </div>
    <div class="page__ft">
        <a href="javascript:home()"><img src="./images/icon_footer_link.png" /></a>
    </div>
            ...
            <div class="weui-picker__bd">
                <div class="weui-picker__group">
                    ...
                    <div class="weui-picker__content">
                        ...
                        <div class="weui-picker__item">住宿费</div>
                        <div class="weui-picker__item">礼品费</div>
                        <div class="weui-picker__item">活动费</div>
                        <div class="weui-picker__item">通讯费</div>
                        <div class="weui-picker__item">补助</div>
    ...
    <div class="page__bd">
        ...
        <div class="weui-form-preview">
            ...
            <div class="weui-form-preview__ft">
                ...
                <button class="weui-form-preview__btn weui-form-preview__btn_primary" href="javascript:">操作</button>
            </div>
        </div>
    </div>
    <div class="page__ft">
